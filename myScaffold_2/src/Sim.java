...
public class Sim {
    ...
    public static void main(String[] args) {
        ...
        Robot robot = new Robot(belt, sensor);
        Inspector inspector = new Inspector(robot);
        AdditionalBelts belts = new AdditionalBelts(inspector);
        Consumer2 consumer2 = new Consumer2(belts);
        ...
        while (consumer.isAlive() && 
               producer.isAlive() && 
               mover.isAlive()&&sensor.isAlive()&&robot.isAlive()
               &&inspector.isAlive()&&belts.isAlive()&&consumer2.isAlive())
            try {
                Thread.sleep(50);
